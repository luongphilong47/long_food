...
<div class="md-pd-left10 grid__item large--one-quarter medium--one-third small--one-half">
	<div class="product-item">
        <div class="product-img">
            <a href="{{route('foods.show', [$f->id])}}">
               <img width="260" height="260" src="/imgs/{{$f->image}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="{{$f->name}}" srcset="/imgs/{{$f->image}}" sizes="100vw" />            </a>
        </div>
        <div class="product-info">
            <div class="product-title">
            	<a href="{{route('foods.show', [$f->id])}}">{{ $f->name }}</a>
            </div>
                        <div class="product-price clearfix">
            	                	<span class="current-price"><span class="woocommerce-Price-amount amount">{{ $f->gia_km }}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
                	<span class="original-price"><s><span class="woocommerce-Price-amount amount">{{ $f->gia }}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
                			</div>
...
@foreach ($food as $f)
	...
	<div class="product-item">
        <div class="product-img">
            <a href="{{route('foods.show', [$f->id])}}">
               <img width="260" height="260" src="/imgs/{{$f->image}}" class="attachment-thumb_260x260 size-thumb_260x260 wp-post-image" alt="NHO XANH" srcset="/imgs/{{$f->image}}" sizes="100vw" />            </a>
        </div>
        <div class="product-info">
            <div class="product-title">
            	<a href="{{route('foods.show', [$f->id])}}">{{ $f->name }}</a>
                	...
                	<div class="wrapper">
						<div class="inner">
                        	<div class="gallery-slider grid">
                                        ...
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63369ace3a2cf" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_1-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63369ace3a2cf" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_2-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_4.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63369ace3a2cf" data-caption="gallery 1">
                                            <img src="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_4-360x255.jpg" alt="">
                                            <div class="overlay"></div>
                                        </a>
                                    </div>
								 									<div class="gallery-item grid__item">
                                        <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/hg_5.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63369ace3a2cf" data-caption="gallery 1">
...
<li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng dẫn mua hàng</a></li>
					...
					<h3 class="footer-title">GALLERY</h3>					<div class="grid gallery-wrapper mg-left-15">
                                ...
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img3.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63369ace3fc3a" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63369ace3fc3a" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63369ace3fc3a" data-caption="gallery 1">
