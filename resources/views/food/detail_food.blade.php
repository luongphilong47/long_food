...
<div class="wpgs wpgs--with-images images">
	...
	<h1 class="product_title-entry-title">{{ $food->name }}</h1></div><div class="pro-price clearfix">
	         <span class="current-price"><span class="woocommerce-Price-amount amount">{{ $food->gia }}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></span>
        <span class="original-price"><s><span class="woocommerce-Price-amount amount">{{ $food->gia_km }}<span class="woocommerce-Price-currencySymbol">&#8363;</span></span></s></span>
...
<div class="product-size-hotline" style="margin-bottom:10px;">
	...
	<form class="cart" action="https://at10.mediawz.com/san-pham/nho-xanh/" method="post" enctype='multipart/form-data'>
			...
			<div class="quantity">
				<label class="screen-reader-text" for="quantity_633987429d1b4">NHO XANH số lượng</label>
		<input
			type="number"
			id="quantity_633987429d1b4"
...
<div class="product_meta">
		...
		<span class="sku_wrapper">Mã: <span class="sku">MSP-0{{$food->id}}</span></span>
...
<li id="menu-item-65" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-65"><a href="https://at10.mediawz.com/huong-dan-mua-hang/">Hướng dẫn mua hàng</a></li>
					...
					<h3 class="footer-title">GALLERY</h3>					<div class="grid gallery-wrapper mg-left-15">
                                ...
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img3.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63398742abd1a" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img2.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63398742abd1a" data-caption="gallery 1">
                                        ...
                                        <div class="overlay"></div>
                                                  	...
                                                  	<div class=" grid__item large--one-third medium--one-third small--one-third  pd-left15">
                                <div class="gallery-item">
                                    <a href="https://at10.mediawz.com/wp-content/uploads/2019/06/ms_banner_img1.jpg" class="fancybox" data-fancybox="home-gallery-images" data-fancybox-group="gallery63398742abd1a" data-caption="gallery 1">
